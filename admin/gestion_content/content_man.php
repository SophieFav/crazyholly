...
echo "<div class='container'>";
	echo "<h4>Content :</h4>";
	//echo"<a href='add_content.php'><img class='add' src='/img/addplus.png'></a>";
echo "</div>";
echo"<table class='section_man'>";
echo"<form method='get' action='modify_content.php'>";

while($data=mysqli_fetch_assoc($result)){
echo"<tr>";
echo"<td><a href='add_content.php'><img class='addnav' src='/img/addplus.png'></a></td>";
echo "<td class='sectionname'>".$data['sectionname']."</td>";
echo "<td><a href='modify_content.php?id=".$data['id']."'class='modifybutton'>Modify</a></td>";
echo "<td><a href='delete_content.php?id=".$data['id']."'class='deletebutton'>Delete</a></td>";
