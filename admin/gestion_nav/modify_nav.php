...
echo "<div id='comment'>";
echo '<form method="get" action="nav_trait.php">';
echo "<input name='navname' type='text' value='" .$data['navname']. "'/>";
echo "<textarea name='navcontent' value=" .$data['navcontent']. " </textarea>";
