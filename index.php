...
<!-- Navbar -->
 ...
 <?php
echo "<nav class='navbar navbar-expand-md bg navbar-dark fixed-top' id='myNavbar'>";
//echo "<div class='container'>";
$db = mysqli_connect("localhost","root","","crazyholly");
$sql = "SELECT * FROM nav_management ";
...
<div id="contact" class="container-fluid bg">
  ...
  <div class="container form">
      ...
      <div class="row">                
          ...
          <div class="col-lg-6">
            ...
            <h4 class="title">Contact Me</h4>
                <div class="form-group">
                  ...
                  <input type="text" placeholder="ex: name@example.com" class="form-control" id="email" name="email" value="" style="border-radius:0px;">
                    <p class="comments"></p>
                </div>
              <div class="form-group">
                <!--<label for="comment">Comment:</label>-->
                <textarea class="form-control" rows="3" id="message" name="message" style="border-radius:0px;"></textarea>
                  <p class="comments"></p>
              </div>
          ...
          <div class="col-xs-6 col-lg-3 hollyis">
