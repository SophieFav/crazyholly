...
<div class="container-fluid banner">
	...
	<div class="container boutons">
        <a class="buttonenter" href="crazyholly.php"><img src="img/bouton-enter.png" onmouseover="this.src='img/bouton-enter-hover.png'" onmouseout="this.src='img/bouton-enter.png'" width="120px"></a>
	</div>
